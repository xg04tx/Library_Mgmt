...
#relation all genre of books
class Genre(models.Model):
    name = models.CharField(max_length=200, help_text="Enter a book genre (e.g. Science Fiction, French Poetry etc.)")

    def __str__(self):
        return self.name
##  override default string returned by object


##relation language of books
...
#book relation that 2 foreign key author language
...
#return canonical url for an object
    ...
    ## override default string returnd by an object
    def __str__(self):
        return self.title
...
#relation info about Borrowed books
